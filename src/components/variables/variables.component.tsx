  ...
  return (
    <ScrollView>
      <Var
        ...
        defaultValue={state.stringVarVal.toString()}
      />
      <Var name={NUM_VARIABLE_NAME} defaultValue={state.numVarVal.toString()} />
      <Var
        name={BOOL_VARIABLE_NAME}
        defaultValue={state.boolVarVal.toString()}
      />
      <Var
        name={ASSET_VARIABLE_NAME}
        defaultValue={state.assetVarName.toString()}
      />
      <Image
        style={{
          width: 51,
        ...
        source={{uri: `data:image/png;base64,${state.assetVarVal}`}}
      />
      <Button
        title="FORCE UPDATE"
        onPress={() => {
